...
Classic Editor is an official WordPress plugin, and will be fully supported and maintained while WordPress supports the classic editor.
...
* Users can optionally disable "remember editor per post" to always use their default.
* Quick editor switching with Alt+Shift+E keyboard shortcut.
* Switch to either editor directly from the post editing screen - no need to go back to the list.
...
* **REST API Support**: New `/wp-json/classic-editor/v1/preferences` endpoint allows managing editor preferences programmatically.
* **Keyboard Shortcut**: Press `Alt+Shift+E` to quickly switch between editors.
* **Remember Per-Post Option**: Users can enable/disable remembering the editor choice for individual posts.
* **Bidirectional Switching**: Switch editors directly from either editor - no more going back to the posts list.
* **Modern PHP 8.2+**: Full strict typing, named arguments, and modern patterns.
* **Improved Security**: Enhanced nonce verification, input sanitization, and AJAX handlers.
* **Better Accessibility**: ARIA labels, focus states, high contrast support, reduced motion support.
* **Improved Styling**: New CSS for better visual consistency with WordPress admin.

== Changelog ==

= 1.7.0 =
* Updated minimum PHP version to 8.2 with strict typing.
* Updated minimum WordPress version to 6.4.
* Added REST API endpoints for editor preferences.
* Added keyboard shortcut (Alt+Shift+E) to switch editors.
* Added AJAX handler for inline editor switching.
* Added bidirectional editor switching in meta boxes.
* Added option to remember editor choice per post.
* Added CSS styling for better admin integration.
...
* Fixed WordPress 6.7+ compatibility for Categories postbox.
...
* Remove warning and automatic deactivation when Gutenberg is not activated.
...
= How do I switch editors quickly? =

Press `Alt+Shift+E` while editing any post to instantly switch to the alternative editor.
